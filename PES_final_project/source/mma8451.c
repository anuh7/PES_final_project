 ...
 * @brief
 *
 * This file has the initialization for mma8451 accelerometer on board and functions to get x,y,z accelerations
 * and functions to calculate roll and pitch angles.
 *
 * @date 09-Dec-2022
 * @author Anuhya
...
float convert_to_pitch() {
	...
	return atan2(ax, sqrt(ay*ay + az*az))*180/M_PI;		//calculation for pitch angle
}
