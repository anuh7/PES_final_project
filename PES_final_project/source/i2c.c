...
#define I2C_M_STOP  	I2C0->C1 &= ~I2C_C1_MST_MASK		//stop condition
#define I2C_M_RSTART 	I2C0->C1 |= I2C_C1_RSTA_MASK		//repeated start condition
...
#define NACK 	        I2C0->C1 |= I2C_C1_TXAK_MASK		//no acknowledgment
#define ACK           I2C0->C1 &= ~I2C_C1_TXAK_MASK			//acknowledgment
...
void i2c_write_byte(uint8_t dev, uint8_t address, uint8_t data)
{
	...
	I2C_M_START;						// send start
	I2C0->D = dev;			  			// send device address
	I2C_WAIT							// wait for acknowledgment
